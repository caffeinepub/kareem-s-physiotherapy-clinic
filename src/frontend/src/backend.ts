...
export class Backend implements backendInterface {
    ...
    async getAppointmentRequest(arg0: bigint): Promise<AppointmentRequest> {
        if (this.processError) {
            try {
    ...
    async submitAppointmentRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
